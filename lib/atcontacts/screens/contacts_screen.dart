...
import 'package:atfind/atcontacts/widgets/add_contacts_dialog.dart';
import 'package:atfind/atcontacts/widgets/bottom_sheet.dart';
import 'package:atfind/atcontacts/widgets/custom_list_tile.dart';
import 'package:atfind/atcontacts/widgets/custom_search_field.dart';
import 'package:atfind/atcontacts/widgets/error_screen.dart';
import 'package:atfind/atcontacts/widgets/horizontal_list_view.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: CustomAppBar(
        ...
        onTrailingIconPressed: () { /// Add a new contact button:
          showDialog(
            context: context,
      ...
      body: errorOcurred
        ...
        child: Column(
          ...
          children: [
            ContactSearchField( /// Search for a contact:
